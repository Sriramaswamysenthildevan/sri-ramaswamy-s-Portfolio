...
import { siteConfig, socialLinks, navItems } from "@/data/siteData";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-zinc-600 text-sm flex items-center gap-1">
            Made with <Heart size={14} className="text-purple-500 fill-purple-500" /> by{" "}
            <span className="text-zinc-400">{siteConfig.shortName}</span>
          </p>
